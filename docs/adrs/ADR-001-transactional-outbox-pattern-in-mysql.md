...
- **Relacionado a:** [ADR-002 — Worker de Webhooks como Processo Node.js Separado](./ADR-002-worker-como-processo-nodejs-separado.md)
- **Relacionado a:** [ADR-003 — Worker de Webhooks com Polling de 2 Segundos na webhook_outbox](./ADR-003-worker-polling-intervalo-dois-segundos.md)
